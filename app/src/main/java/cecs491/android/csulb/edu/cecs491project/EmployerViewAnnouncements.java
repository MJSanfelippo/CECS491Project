...
public class EmployerViewAnnouncements extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.navigation_home:
                        intent = new Intent(EmployerViewAnnouncements.this, EmployerHomePageActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.navigation_profile:
                        intent = new Intent(EmployerViewAnnouncements.this, EmployerProfileActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.navigation_schedule:
                        intent = new Intent(EmployerViewAnnouncements.this, EmployerScheduleActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.navigation_announcements:
                        return true;
                    case R.id.navigation_admin:
                        intent = new Intent(EmployerViewAnnouncements.this, EmployerAdminActivity.class);
                        startActivity(intent);
                        return true;
                }
                return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_view_announcements);
